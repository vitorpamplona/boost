...
import { useStatusBarEffect, VaccineEligibilityFlowStackScreens } from "../navigation"
...
export const VaccineEligibilityFlowIntro: FunctionComponent = () => {
  ...
  const handleOnPressContinue = () => {
    navigation.navigate(VaccineEligibilityFlowStackScreens.VaccineEligibilityCodeInput)
  }
  ...
  return (
    ...
    >
      <View>
        ...
        />
        <Text style={style.headerText}>{t("vaccination_history.eligibility_intro.header")}</Text>
        <Text style={style.bodyText}>
          {t("vaccination_history.eligibility_intro.body1", { healthAuthorityName })}
        </Text>
        <Text style={style.bodyText}>
          {t("vaccination_history.eligibility_intro.body2", { healthAuthorityName })}
        </Text>
      </View>
      <View>
        <TouchableOpacity
        ...
        <TouchableOpacity
          ...
          accessibilityLabel={t("vaccination_history.eligibility_intro.what_is_a")}
        >
...
export default VaccineEligibilityFlowIntro
