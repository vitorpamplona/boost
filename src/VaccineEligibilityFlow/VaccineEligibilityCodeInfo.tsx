...
const MoreInfo: FunctionComponent = () => {
  ...
  const verificationCodeInfoText =
    verificationCodeInfo ||
    t("vaccination_history.eligibility_code_info.info_body", { healthAuthorityName })
  const verificationCodeHowDoIGetText =
    verificationCodeHowDoIGet ||
    t("vaccination_history.eligibility_code_info.how_do_i_get_body", {
      healthAuthorityName,
    })
      ...
      >
        <View style={style.section}>
          <Text style={style.headerText}>
            {t("vaccination_history.eligibility_code_info.info_header")}
          </Text>
          <Text style={style.contentText}>{verificationCodeInfoText}</Text>
        </View>
        <View style={style.section}>
          <Text style={style.headerText}>
            {t("vaccination_history.eligibility_code_info.how_do_i_get_header")}
          </Text>
        ...
        <View style={style.section}>
          <Text style={style.headerText}>
            {t("vaccination_history.eligibility_code_info.what_happens_header")}
          </Text>
          <Text style={style.contentText}>
            {t("vaccination_history.eligibility_code_info.what_happens_body")}
          </Text>
        </View>
      </ScrollView>
    </>
